...
var imageShadow = (function (elem, value) {
  ...
  var min = !isNaN(options.min) ? options.min : 0.75;
  var scale = (max - min) * value;
  elem.style['filter'] = `brightness(10%) sepia(1) saturate(100) hue-rotate(275deg) drop-shadow(0 0 ${scale}px #a59ed9)`
})

var reset$17 = function reset(elem) {
  elem.style['filter'] = 'brightness(10%) sepia(1) saturate(100) hue-rotate(275deg) drop-shadow(0 0 10px #a59ed9)'
}
